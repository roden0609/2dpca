...
class TwoDPCA:
    ...
    def __init__(self, images, y, target_names, quality_percent):
    ...
    def reduce_dim(self):
        ...
        # creating empty matrix for find covariance matrix
        ...
        p = self.give_p(d_mat)
        print("No. of eig_vals in 2DPCA to keep", self.quality_percent, "quality_percent:", p)
    ...
    def recognize_face(self, new_cord):
        ...
        # print("Person", per, ":", min, self.target_names[per], "Dist:", distances[min_dis])
        return per_name
